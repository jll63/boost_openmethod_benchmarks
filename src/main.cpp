        ...
        for (std::size_t j = 0; j < e.ptrs.size(); j += 89) {
            ...
            const check checks[] = {
                ...
                {"vec vpu1", pokeu_vp<vector_registry>::fn(e.vp_vec[i]).id,
                 want1},
                {"map vpu1", pokeu_vp<map_registry>::fn(e.vp_map[i]).id,
                 want1},
                {"flat vpu1", pokeu_vp<flat_registry>::fn(e.vp_flat[i]).id,
                 want1},
                ...
                {"vec vpu2",
                 ...
                 wantu2},
                {"map vpu2",
                 collideu_vp<map_registry>::fn(e.vp_map[i], e.vp_map[j]).id,
                 wantu2},
                {"flat vpu2",
                 collideu_vp<flat_registry>::fn(e.vp_flat[i], e.vp_flat[j]).id,
                 wantu2},
                {"ind vpu2",
